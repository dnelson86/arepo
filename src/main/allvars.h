...
#if !defined(OUTPUT_PRESSURE_GRADIENT) && !defined(OUTPUT_DENSITY_GRADIENT) && !defined(OUTPUT_VELOCITY_GRADIENT) && !defined(OUTPUT_BFIELD_GRADIENT) && !defined(OUTPUT_DIVVEL) && !defined(OUTPUT_CURLVEL) && !defined(OUTPUT_VORTICITY)
// only if no gradient output defined, no need to update them directly before output.
#else /* #if !defined(OUTPUT_PRESSURE_GRADIENT) && !defined(OUTPUT_DENSITY_GRADIENT) && !defined(OUTPUT_VELOCITY_GRADIENT) && !defined(OUTPUT_BFIELD_GRADIENT) && !defined(OUTPUT_DIVVEL) && !defined(OUTPUT_CURLVEL) && !defined(OUTPUT_VORTICITY) */
#define UPDATE_GRADIENTS_FOR_OUTPUT
#endif /* #if !defined(OUTPUT_PRESSURE_GRADIENT) && !defined(OUTPUT_DENSITY_GRADIENT) && !defined(OUTPUT_VELOCITY_GRADIENT) && !defined(OUTPUT_BFIELD_GRADIENT) && !defined(OUTPUT_DIVVEL) && !defined(OUTPUT_CURLVEL) && !defined(OUTPUT_VORTICITY) #else */
...
#define NO_SELFGRAVITY_TYPE EXACT_GRAVITY_FOR_PARTICLE_TYPE        // exclude particle type from self-gravity (can be used with exact gravity)
...
#endif /* #if defined(VORONOI_STATIC_MESH) && !defined(FORCE_EQUAL_TIMESTEPS) && !defined(VORONOI_STATIC_MESH_DO_DOMAIN_DECOMPOSITION) #else */
...
extern struct global_data_all_processes
{
  ...
  double MinEgySpec;            /*!< the minimum allowed temperature expressed as energy per unit mass; code will inject energy if a cell falls below this limit */
