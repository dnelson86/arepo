...
{
  ((MyOutputFloat *) out_buffer)[0] = (P[particle].TimeBinHydro ? (((integertime) 1) << P[particle].TimeBinHydro) : 0) * All.Timebase_interval;
}
...
void init_io_fields()
{
  ...
  init_units(IO_GRADP, -4.0, 3.0, -4.0, 1.0, 2.0, All.UnitDensity_in_cgs * All.UnitVelocity_in_cm_per_s * All.UnitVelocity_in_cm_per_s / All.UnitLength_in_cm);
